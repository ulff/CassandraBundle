                        ...
                        ->children()
                            ...
                            ->arrayNode('dc_options')
                                ->children()
                                    ...
                                    ->integerNode('host_per_remote_dc')->isRequired()->end()
                            ...
                            ->integerNode('default_timeout')->end()
                            ->arrayNode('timeout')
                                ->addDefaultsIfNotSet()
                                ->children()
                                    ->integerNode('connect')->isRequired()->defaultValue(5)->end()
                                    ->integerNode('request')->isRequired()->defaultValue(5)->end()
                                ->end()
                            ->end()
                            ->arrayNode('retries')
                                ->addDefaultsIfNotSet()
